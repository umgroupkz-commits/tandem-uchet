-- Кнопка «Загрузить прейскурант» в номенклатуре: цены по точкам из «Сводного прейскуранта» iiko без
-- скрипта и служебного ключа. Права — nomenclature:edit. office_nomenclature — тело из 0026 + действие.
