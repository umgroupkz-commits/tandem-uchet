...
`db/migrations` новее снимка. Сейчас снимок включает миграции 0001–0034 (0033–0034 внесены скриптом, тела функций сверены с базой по md5). Запрос — `db/schema/snapshot-query.sql`, сборка файла —
