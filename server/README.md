...
`db/migrations` новее снимка. Сейчас снимок включает миграции 0001–0033 (0033 внесена скриптом, тела функций сверены с базой по md5). Запрос — `db/schema/snapshot-query.sql`, сборка файла —
