import { api, session, setSession } from "../office/api.js?v=10";
import { el, toast } from "../office/ui.js?v=10";
import { ask, clearDraftsAll } from "./common.js?v=10";
...
async function openScenario(id) {
  ...
  try {
    const mod = await import(`./${id}.js?v=10`);
